...
class FormalsListNode extends ASTnode {
    ...
    /**
     * Unparse function for formalsLists, initalize an iterator for the list
     * item. Then in a try and catch block, while there is another element
     * unparse and print a ", " spacer.
     */
    public void unparse(PrintWriter p, int indent) {
        Iterator<FormalDeclNode> iterator = myFormals.iterator();
        try {
            while (iterator.hasNext()) {
                iterator.next().unparse(p, indent);
                if (iterator.hasNext()) {
                    p.print(", ");
                }
            }
...
class FnBodyNode extends ASTnode {
    ...
    /**
     * Function body unparcing function: Just unparse both the declarations list
     * and the statements list.
     */
    public void unparse(PrintWriter p, int indent) {
        myDeclList.unparse(p, indent);
...
class StmtListNode extends ASTnode {
    ...
    /**
     * Unparsing function for statement lists: initialize an iterator for the
     * statement node item. Then in a try and catch block, while there is
     * another element, add an indentation and unparse the next element.
     */
    public void unparse(PrintWriter p, int indent) {
        Iterator<StmtNode> iterator = myStmts.iterator();
        try {
            while (iterator.hasNext()) {
...
class ExpListNode extends ASTnode {
    ...
    /**
     * Unparsing function for Exp List:
     * 
     * Initialize an iterator for the ExpNode objects. Then in a try and catch
     * block unparse elements and add a ", " sperator.
     */
    public void unparse(PrintWriter p, int indent) {
        Iterator<ExpNode> iterator = myExps.iterator();
        try {
            while (iterator.hasNext()) {
                iterator.next().unparse(p, indent);
                if (iterator.hasNext()) {
